...
class BookingsTable extends Table {
  ...
  IntColumn get createdByUserId =>
      integer().nullable().named('created_by_user_id')();
  ...
  TextColumn get specialRequests =>
      text().nullable().named('special_requests')();
  TextColumn get notes => text().nullable()();
  TextColumn get modificationReason =>
      text().nullable().named('modification_reason')();
